...
# legend.box.background = element_rect(color = NA, fill =NA)
  ...
  p_bar_yearly_diff+
  labs(
    subtitle = "2024 vs 2023 Fatalities"
  )+
  theme(
    plot.title= element_blank(),
    plot.subtitle = element_text(size =9),
  ...
  patchwork::plot_annotation(
    title= "Change in conflict related fatalities between 2023 & 2024", 
    caption = "Latest Conflict Data: ACLED: 2024-11-28
Black lines delineate areas used in 2023 HNO to define Al-Shabaab vs Interclan violence zones. Grey fill on maps means no fatalities of respective classification in either 2023 or 2024",
    theme = theme(
      plot.caption = element_text(hjust = 0 )
    )
    )
